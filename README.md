...
4. [Instruções para Configuração e Execução do Projeto](#4-instruções-para-configuração-e-execução-do-projeto)
   ...
   - [Passos de Configuração](#42-passos-de-configuração)
       ...
       - [STEP 2. Criar usuário de serviço (Service Principal) com as seguintes atribuições](#step-1-clone-o-repositório)
       - [STEP 3. Configure as variaveis de ambiente (secrets) em seu repositório Git, ](#step-1-clone-o-repositório)
       - [STEP 4. Configurar arquivo .yaml de setup lakehouse](#step-1-clone-o-repositório)
       - [STEP 2. Criar usuário de serviço (Service Principal) com as seguintes atribuições](#step-1-clone-o-repositório)
       - [STEP 2. Criar usuário de serviço (Service Principal) com as seguintes atribuições](#step-1-clone-o-repositório)
       - [STEP 2. Criar usuário de serviço (Service Principal) com as seguintes atribuições](#step-1-clone-o-repositório)
